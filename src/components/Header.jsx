        ...
        <div className="w-full h-screen bg-black/40 fixed top-0 left-0 flex justify-center items-center z-30">
          <div className="w-fit bg-white p-4 rounded-lg flex-col flex gap-4 justify-center relative scale">
            ...
            <div className="flex gap-4">
              <div className="w-full grid grid-cols-3 md:flex flex-wrap gap-4 justify-center mt-0">
                <a href="tel:00447300313668">
                  {" "}
                  <div className="bg-white/60 shadow-md p-2 md:px-6 md:py-4 rounded-md hover:bg-[#4b2a05]/20 flex flex-col gap-1 justify-center items-center font-medium">
                    <img
                      src="/images/phone.png"
                      alt=""
                      className="md:w-14 md:h-14 w-10 h-10 "
                    />
                    <p className="hidden md:block font-normal">Call Us</p>
                    {/* <p className="hidden md:block font-normalfont-medium text-[1.25rem]">+1 456 777 6341</p> */}
                  </div>
                </a>
                ...
                <a href="https://wa.me/+447300313668">
                  <div className="bg-white/60 shadow-md p-2 md:px-6 md:py-4 rounded-md hover:bg-[#4b2a05]/20 flex flex-col gap-1 justify-center items-center font-medium">
                    <img
                      ...
                      className="md:w-14 md:h-14 w-10 h-10 "
                    />
                    <p className="hidden md:block font-normal">Whatsapp</p>
                  </div>
                </a>
                <a href="https://www.facebook.com/profile.php?id=100092990044684">
                  <div className="bg-white/60 shadow-md p-2 md:px-6 md:py-4 rounded-md hover:bg-[#4b2a05]/20 flex flex-col gap-1 justify-center items-center font-medium">
                    <img
                      ...
                      className="md:w-14 md:h-14 w-10 h-10 "
                    />
                    <p className="hidden md:block font-normal">Facebook</p>
                  </div>
                </a>
                <a href="https://twitter.com/stcogaukeurope">
                  <div className="bg-white/60 shadow-md p-2 md:px-6 md:py-4 rounded-md hover:bg-[#4b2a05]/20 flex flex-col gap-1 justify-center items-center font-medium">
                    <img
                      ...
                      className="md:w-14 md:h-14 w-10 h-10 "
                    />
                    <p className="hidden md:block font-normal">Twitter</p>
                  </div>
                </a>
                ...
                <a href="https://www.instagram.com/stcoga_ukandeurope/">
                  <div className="bg-white/60 shadow-md p-2 md:px-6 md:py-4 rounded-md hover:bg-[#4b2a05]/20 flex flex-col gap-1 justify-center items-center font-medium">
                    <img
                      ...
                      className="md:w-14 md:h-14 w-10 h-10 "
                    />
                    <p className="hidden md:block font-normal">Instagram</p>
                  </div>
                </a>
